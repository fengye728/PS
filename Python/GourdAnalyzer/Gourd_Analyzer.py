...
# constant
GOURD_COLUMN_LIST = ['event_day', 'symbol', 'strike', 'expiration', 'call_put', 'price', 'size', 'size_count', 'total_size', 'millionD']
GOURD_SQL = " \
SELECT event_day, stock_symbol, strike, expiration, call_put, ROUND(AVG(price), 2) as price, size, COUNT(size) as size_count, SUM(size) as total_size, ROUND(SUM(price * size / 10000), 3) as millionD \
